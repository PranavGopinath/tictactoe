...
class TicTacToe:
    ...
    def on_click(self, row, col):
        ...
        if self.board[row, col] == "":
            ...
            # checking for a winner or tie, and updating the game accordingly
